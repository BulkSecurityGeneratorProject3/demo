package com.alozanpe.demo.config;
...
@Configuration
@EnableMongoRepositories("com.alozanpe.demo.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.alozanpe.demo.config.dbmigrations");
